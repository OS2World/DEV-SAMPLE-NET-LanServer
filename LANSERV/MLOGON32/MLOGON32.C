 ...
 *    @Copyright International Business Machines Corp. 1984, 1994
...
main(int argc, char *argv[])
{
    ...
    {
        printf("Error: upmeulgn() returned = %X\n",usRc);
    ...
    if (!usRc)
    {
        do
        {
            ...
            if (!usRc)
            {
                ...
                {
                    printf("Error: upmeulgf() returned = %X\n", usRc);
                    break;
                }
            }
